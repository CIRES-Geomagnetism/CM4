...
int main(){
    ...
    char crust_out_file[50] = "test_values/cm4_crust_TestValues.csv";
    char core_out_file[50] = "test_values/cm4_core_TestValues.csv";
    char iono_out_file[50] = "test_values/cm4_iono_TestValues.csv";
    char magneto_out_file[50] = "test_values/cm4_magneto_TestValues.csv";
